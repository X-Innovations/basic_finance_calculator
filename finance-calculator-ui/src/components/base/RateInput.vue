...
// can combine this with PriceInput with a prop to switch formatting
...
const displayValue = computed(() => inFocus.value ? valueNumber.value : formatPercentage(valueNumber.value));
